...
const fromSelector = document.querySelector('select[name="from_currency"]');
const toSelector = document.querySelector('select[name="to_currency"]');
const fromInput = document.querySelector('input[name="from_amount"]');
const myForm = document.querySelector('.app form');
const toEl = myForm.querySelector('.to_amount');
